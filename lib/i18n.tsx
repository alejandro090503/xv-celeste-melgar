...
const dict = {
  es: {
    ...
    regalos: {
      ...
      body: "Tu cariño y presencia son el mejor regalo que puedo recibir. Si deseas obsequiarme algo, será con mucho gusto recibido.",
      ariaSobre: "Sobre — toca para abrir",
      lluvia: "Lluvia de Sobres",
      lluviaBody: "Un sobre con tu bendición llenará mi corazón de alegría.",
      tocaSobre: "Toca el sobre",
    },
    album: {
    ...
    noNinos: {
      text: "Con cariño te pedimos que este sea un evento solo para adultos.",
    },
    rsvp: {
  ...
  en: {
    ...
    regalos: {
      eyebrow: "Gifts",
      title: "Gift Registry",
      body: "Your love and presence are the best gift I could receive. If you wish to give me something, it will be gladly welcomed.",
      ariaSobre: "Envelope — tap to open",
      lluvia: "Envelope Shower",
      lluviaBody: "An envelope with your blessing will fill my heart with joy.",
      tocaSobre: "Tap the envelope",
    },
    album: {
    ...
    noNinos: {
      text: "With love, we kindly ask that this be an adults-only event.",
    },
    rsvp: {
